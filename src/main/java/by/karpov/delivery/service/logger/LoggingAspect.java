package by.karpov.delivery.service.logger;
...
public class LoggingAspect {
    ...
    @Pointcut(value = "execution(* by.karpov.delivery.service.impl.OrderServiceImpl.*(..))")
    public void callAtOrderServicePublic() {
    }

    @Pointcut(value = "execution(* by.karpov.delivery.service.impl.OrderServiceImpl.getAllByUser(..))")
